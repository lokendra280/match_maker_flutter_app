...
class ImageSlider extends StatefulWidget {
  ...
  @override
  State createState() => ImageSliderState();
}
...
class ImageSliderState extends State<ImageSlider> {
  ...
  Widget build(BuildContext context) {
    final listImages = widget.images.map<Widget>(
      (netImage) {
    ...
    return Stack(
      children: <Widget>[
            ...
            builder: (_) {
              Widget pageView = PageView(
                ...
                onPageChanged: (currentPage) {
                  ...
                  if(widget.counterWidget==null)  setState(() {
        ...
        widget.showIndicator
            ...
            : Container(),
      if(widget.counterWidget==null)   Positioned(
          bottom: SC.lH,
          right: SC.lW,
          child: Container(
            padding: const EdgeInsets.symmetric(vertical: SC.sW,horizontal: SC.lW),
            decoration: BoxDecoration(
...
class DotsIndicator extends AnimatedWidget {
  ...
  // The number of home_drawer managed by the PageController
  final int? itemCount;
  ...
  Widget _buildDot(int index) {
    ...
    var zoom = 1.0 + (dotIncreaseSize! - 1.0) * selectedness;
